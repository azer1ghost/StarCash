            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
               ...
               <div class="table-responsive">
                  <table class="table table-striped table-sm">
                    ...
                    <?php $customersor=$db->prepare("SELECT * FROM `customer` order by customer_id DESC");
                          $customersor->execute(array()); $n=0;
                          $valuye=$customersor->rowCount();
                          if ($valuye == null){ ?>

                           <tr>
                             <td>Hal hazırda heç bir istifadəçi yoxdur</td>
                           </tr>
                    ...
                    <?php } else{ ?>
                     ...
                     <?php } while($customercek=$customersor->fetch(PDO::FETCH_ASSOC)){ $n++;
                                   $cusID = $customercek['customer_id'];
                        ?>


                       <div class="time"  style="display:none">
                         <?php echo $customercek['customer_time'] ?>
                       </div>

                        <tr>
                           <td><?php echo $n; ?></td>
                           <td><?php echo $customercek['customer_username']; ?></td>
                           <td><?php echo $customercek['customer_date']; ?></td>
                           <td><?php echo $customercek['customer_name']." ".$customercek['customer_surname']; ?></td>
                           <th><?php echo $customercek['customer_email']; ?></th>
                           <td><?php echo $customercek['customer_birth']; ?></td>
                           <td ondblclick="ShowPass(<?php echo $cusID; ?>)">CODE</td>
                           <td><div style="display:none" id="<?php echo $cusID; ?>"><?php echo $customercek['customer_pass']; ?></div></td>
                       </tr>
