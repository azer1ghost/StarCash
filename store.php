      ...
      <div class="container-fluid">
         <div class="row">
            <nav class="col-md-2 d-none d-md-block bg-light sidebar">
              <h2 style="padding:10px;font-size:22px"><?php echo $user ?></h2>
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
               ...
               <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
                  <h1 class="h2">Mövcud paketlər</h1>
                  <!--
               ...
               <div class="table-responsive">
                  <table class="table table-striped table-sm">
                    ...
                    <?php $ordersor=$db->prepare("SELECT * from packs order by pack_id DESC");
                          $ordersor->execute(array()); $n=0;
                          $valuye=$ordersor->rowCount();
                          if ($valuye == null){ ?>

                           <tr>
                             <td>Hal hazırda heç bir mövcud paket yoxdur</td>
                           </tr>
                    ...
                    <?php } else{ ?>
                     ...
                     <?php } while($ordercek=$ordersor->fetch(PDO::FETCH_ASSOC)){ $n++;  ?>
                       ...
                       <div class="time"  style="display:none">
                        ...
                        <tr>
                           <td><?php echo $n; ?></td>
                           <td><?php echo $ordercek['pack_name']; ?></td>
                           <th><?php echo $ordercek['pack_price']; ?> AZN</th>
                           <td><a href="profile.php?order_id=<?php echo $ordercek['pack_id']; ?>"><button class="button button1">Satın al</button></a></td>
                           <td><button onclick="ShowInfo('<?php echo $ordercek['pack_text']; ?>')" class="button button1">Haqqında</button></td>
